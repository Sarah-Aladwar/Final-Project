                  ...
                  @method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" name="fullname" value="{{ old('fullname', $user->fullname) }}" class="form-control ">
												@error('fullname')
													{{ $message }}
												@enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" required="required" name="username" value="{{ old('username', $user->username) }}" class="form-control">
												@error('username')
													{{ $message }}
												@enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password" name="password" placeholder="••••••••" class="form-control" @if(empty(old('password', $user->password))) required @endif>
												@error('password')
													{{ $message }}
												@enderror
											</div>
