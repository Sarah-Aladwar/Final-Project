                    ...
                    @method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" required="required" class="form-control " name="title" value="{{ old('title', $car->title) }}">
                        @error('title')
                          {{ $message }}
                        @enderror
                      </div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="date_posted" name="date_posted" value="{{ old('date_posted', $car->date_posted) }}" required="required" class="form-control ">
												@error('date_posted')
                         {{$message}}
                        @enderror
										  </div>       
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control">{{ old('content', $car->content) }}</textarea>
												@error('content')
                          {{ $message }}
                        @enderror
											</div>
                        ...
                        @enderror
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="published" @checked($car->published) class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
