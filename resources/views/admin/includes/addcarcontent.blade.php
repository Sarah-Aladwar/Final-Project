					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('displaycar')}}" method="POST" enctype="multipart/form-data">
										@csrf
                        ...
                        @enderror
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="date_posted">Date Posted <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="date_posted" name="date_posted" value="{{ old('date_posted') }}" required="required" class="form-control ">
												@error('date_posted')
                         {{$message}}
                        @enderror
										  </div>       
                        ...
                        @enderror
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="passengers" class="form-control" type="number" name="passengers" value="{{ old('passengers') }}" required="required">
                        @error('passengers')
                          {{$message}}
                        @enderror
                      </div>
                        ...
                        @enderror
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" required="required" name="category_id" id="">
                        <option value=""></option>
                        @foreach($cat as $c)
                        ...
                        @enderror
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
											  <a href="{{ route('addcar')}}"><button class="btn btn-primary" type="button">Cancel</button></a>
