          ...
          <div class="row align-items-end ">
            <div class="col-lg-12">
              ...
              <div class="intro">
                ...
                <div class="pb-4"><strong class="text-black">Posted on {{ \Carbon\Carbon::parse($car->date_posted)->format('M d, Y') }}</strong></div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            </div>  {{--  {!! nl2br(e($car->content)) !!}  --}}

            <p class="lead">{{ $car->content }}</p>

            <div class="pt-5">
              <p>Category:  <a href="#">{{ $car->category->category_name }}</a></p>
            </div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                <h3>Categories</h3>
                @foreach($cat as $c)
                <li><a href="#">{{$c->category_name}} <span>({{$c->publishedcars_count}})</span></a></li>
                @endforeach
              </div>
            </div>
            <div class="sidebar-box">
